...
CREATE INDEX idx_product_question_product_code ON `product_question`(`product_code`);
CREATE INDEX idx_product_answer_question_code ON `product_answer`(`question_code`);
